// Registro central das ferramentas do hub.
// Para adicionar uma nova ferramenta: acrescente um item ao array abaixo.
// Isso alimenta a grade exibida em index.html (ver js/hub.js).
window.ELOJA_TOOLS = [
  {
